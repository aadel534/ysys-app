...
export const getData = async (searchNumber, searchMode, searchQuery) => {
    const apiCall = `https://anapioficeandfire.com/api/${searchMode}?name=${searchQuery}&page=1&pageSize=${searchNumber}`;
