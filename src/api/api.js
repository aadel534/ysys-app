...
export const getData = async (howMany,searchMode, searchQuery) => {
    const apiCall = `https://anapioficeandfire.com/api/${searchMode}?name=${searchQuery}&page=1&pageSize=${howMany}`;
